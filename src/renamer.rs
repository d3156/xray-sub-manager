...
fn country_label(raw_name: &str) -> String {
    if let Some((flag, code)) = extract_flag(raw_name) {
        let country = country_map().get(code.as_str()).copied().unwrap_or("Unknown");
...
fn extract_flag(input: &str) -> Option<(String, String)> {
    ...
    for window in chars.windows(2) {
        ...
        if is_regional_indicator(first) && is_regional_indicator(second) {
            let code = format!("{}{}", regional_indicator_to_ascii(first)?, regional_indicator_to_ascii(second)?);
...
fn country_map() -> &'static HashMap<&'static str, &'static str> {
    ...
    COUNTRY_MAP.get_or_init(|| {
        HashMap::from([
            ...
            ("CP", "Clipperton Island"), ("CR", "Costa Rica"), ("CU", "Cuba"), ("CV", "Cape Verde"), ("CW", "Curacao"),
            ("CX", "Christmas Island"), ("CY", "Cyprus"), ("CZ", "Czechia"), ("DE", "Germany"), ("DG", "Diego Garcia"),
            ("DJ", "Djibouti"), ("DK", "Denmark"), ("DM", "Dominica"), ("DO", "Dominican Republic"), ("DZ", "Algeria"),
            ("EA", "Ceuta and Melilla"), ("EC", "Ecuador"), ("EE", "Estonia"), ("EG", "Egypt"), ("EH", "Western Sahara"),
            ...
            ("IC", "Canary Islands"), ("ID", "Indonesia"), ("IE", "Ireland"), ("IL", "Israel"), ("IM", "Isle of Man"),
